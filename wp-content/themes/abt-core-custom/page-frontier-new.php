  ...
  <div class="content-container" id="frontier-homepage">
    ...
    <div class="frontier-map">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 976.83 498.66">
        <a target="_blank" xlink:href="<?php echo $map_links['building_700']; ?>" target="_blank">
        ...
        <a target="_blank" xlink:href="<?php echo $map_links['building_600']; ?>" target="_blank">
        ...
        <a target="_blank" xlink:href="<?php echo $map_links['building_800']; ?>" target="_blank">
        ...
        <a target="_blank" xlink:href="<?php echo $map_links['building_400']; ?>" target="_blank">

...
class abt_core_custom_theme {
    ...
    $theme        = wp_get_theme();
      ...
      if (is_page_template('page-directory.php') || is_page('directory')) {
        wp_enqueue_script('page-directory-script', 'https://api.tiles.mapbox.com/mapbox-gl-js/v0.44.2/mapbox-gl.js', array(), null, false);
        wp_enqueue_style('page-directory-style', 'https://api.tiles.mapbox.com/mapbox-gl-js/v0.44.2/mapbox-gl.css', null, false);
      }
		}
...
/**
 * Register new post types for directory
 */

function rtp_create_post_types() {

  register_post_type('rtp-facility', array(
    'labels' => array(
			'name' => 'Facilities',
  ...
  register_post_type('rtp-company', array(
    'labels' => array(
			'name' => 'Companies',
  ...
  register_post_type('rtp-site', array(
    'labels' => array(
			'name' => 'Sites',
			'singular_name' => 'Site',
			'add_new' => 'Add New',
  ...
  register_post_type('rtp-space', array(
    'labels' => array(
			'name' => 'Spaces',
			'singular_name' => 'Space',
			'add_new' => 'Add New',
  ...
  register_taxonomy('rtp-facility-type', 'rtp-facility', array(
		'labels' => array(
			'name' => __( 'Facility Types' ),
			'singular_name' => __( 'Facility Type' )
		),
		'publicly_queryable' => true,
		'show_ui' => true,
		'show_in_nav_menus' => false,
  ...
  register_taxonomy('rtp-company-type', 'rtp-company', array(
		'labels' => array(
  ...
  register_taxonomy('rtp-availability', array('rtp-site', 'rtp-space'), array(
		'labels' => array(

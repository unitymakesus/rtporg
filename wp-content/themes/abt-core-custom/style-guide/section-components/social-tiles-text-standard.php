...
<article class="component" data-content="components-social-tiles">
    <h2 class="title">Social Tile - Text, Standard</h2>
    <p class="description">Display the standard size text-only tile.</p>
    <div class="preview">
        <section class="social-grid">
            <article class="social-tile type-text standard hentry" style="width: 300px; padding-bottom: 300px;">

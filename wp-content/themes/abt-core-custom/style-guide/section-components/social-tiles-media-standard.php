...
<article class="component" data-content="components-social-tiles">
    <h2 class="title">Social Tile - Media, Standard</h2>
    <p class="description">Display the standard size media-only tile.</p>
    <div class="preview">
        <section class="social-grid">
            <article class="social-tile type-media standard hentry" style="width: 300px; padding-bottom: 300px; background-image: url(http://distilleryimage4.ak.instagram.com/2e04e83acbfe11e3b6a30002c954b60c_8.jpg);">

...
<article class="component" data-content="components-social-tiles">
    <h2 class="title">Social Tile - Text, Featured</h2>
    <p class="description">Display the featured size text-only tile.</p>
    <div class="preview">               
        <section class="social-grid">   
            <article class="social-tile type-text featured hentry" style="width: 600px; padding-bottom: 300px;">
                <div class="entry-title">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed nec purus in ante pretium blandit. Aliquam erat volutpat. Nulla libero <a href="#">#lectus</a>.</p>
                </div>
                    ...
                    <ul>
                        <li data-option="favorite">
                            <span class="label" title="Favorite">
                                <img class="svg" src="<?php echo $theme_dir; ?>/img/icons/i_favorite.svg" />
                                <span class="visuallyhidden">Favorite</span>
                            </span>
                            <div class="panel">
                                <h3>Likes</h3>
                                <div class="likes">168</div>
                                <button class="secondary"><img class="svg" src="<?php echo $theme_dir; ?>/img/icons/i_favorite.svg" /> Like?</button>

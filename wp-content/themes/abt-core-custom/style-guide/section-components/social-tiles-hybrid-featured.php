...
<article class="component" data-content="components-social-tiles">
    <h2 class="title">Social Tile - Hybrid, Featured</h2>
    <p class="description">Display the featured size media-only tile.</p>
    <div class="preview">
        <section class="social-grid">
            <article class="social-tile type-hybrid featured hentry" style="width: 600px; padding-bottom: 300px; background-image: url(https://i1.ytimg.com/vi/WTJgFsREXTw/sddefault.jpg);">

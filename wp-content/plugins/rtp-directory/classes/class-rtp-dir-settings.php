...
/**
 * RTP_Dir_Settings Class
 *
 * @class RTP_Dir_Settings
 * @version	1.0.0
 * @since 1.0.0
 * @package	RTP_Dir
 * @author Jeffikus
 */
final class RTP_Dir_Settings {
	/**
	...
	/**
	 * Main RTP_Dir_Settings Instance
	 *
	 * Ensures only one instance of RTP_Dir_Settings is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @return Main RTP_Dir_Settings instance
	 */
	...
	public function render_field ( $args ) {
		...
		// Construct the key.
		$key 				= RTP_Dir()->token . '-' . $args['section'] . '[' . $args['id'] . ']';
